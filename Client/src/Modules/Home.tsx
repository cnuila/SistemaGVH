...
type State = {
    ...
    selectedLocationForMonthAvg: IDeliveryLocationViewData | null,
    message: IMessage,
...
export default class Home extends Component<Props, State> {
    ...
    state: State = {
        ...
        columnHeadersAvgDelivered: [
            ...
            { field: "totalDelivered", headerName: "Total Entregado", headerAlign: "center", align: "center", width: 120, type: "number" },
            { field: "avgMonthlyDelivered", headerName: "Promedio Mensual", headerAlign: "center", align: "center", width: 200, type: "number" },
        ],
        avgProductsDeliveredByLocation: [],
        selectedPlace: null,
        selectedLocationForMonthAvg: null,
        expirationAVG: 0,
